...
public sealed class HttpServerRequestCountMiddleware : HttpServerMiddlewareBase
{
    ...
    private readonly Counter _HttpRequestCounter = Metrics.CreateCounter("http_server_requests_total", "Total number of http requests", "Method", "Endpoint", "ServiceCaller");
    ...
    public async Task Invoke(HttpContext context)
    {
        ...
        _HttpRequestCounter.WithLabels(context.Request.Method, endpoint, GetServiceCaller(context)).Inc();
